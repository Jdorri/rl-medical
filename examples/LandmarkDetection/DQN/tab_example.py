...
from PyQt5.QtWidgets import QApplication, QDialog,QTabWidget, QComboBox, QCheckBox ,QGroupBox ,QVBoxLayout, QWidget, QLabel, QLineEdit, QDialogButtonBox, QFrame
import sys
...
class TabPeronsalDetails(QFrame):
    def __init__(self):
        super().__init__()
