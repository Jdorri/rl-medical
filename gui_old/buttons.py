import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QGridLayout, QWidget, QPushButton, QToolButton
...
class App(QWidget):
    ...
    def __init__(self, rect_centre, target, spacing, error, depth):
        ...
        self.grid.addWidget(QPushButton('Up'),1,1,1,1)
        self.grid.addWidget(QPushButton('Down'),1,1,10,1)
        self.grid.addWidget(QPushButton('Right'),1,1,6,1)
        self.grid.addWidget(QPushButton('Left'),1,1,6,1)
    ...
    # Create a button to toggle the details frame.              
        ...
        self._detailsbutton.setArrowType(QtCore.Qt.RightArrow)                         
        self._detailsbutton.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)           
        # self._detailsbutton.setFixedSize( 10, 10 )                              
        # self._detailsbutton.toggled.connect(self.showDetails)
        self.grid.addWidget(self._detailsbutton, 2,1)
